<?php 
// kemudian untuk bagian upload foto sama seperti upload foto yang di user 
// dimana terdapat 2 pilihan yang harus di pilih satu kemudian bisa upload secara  upload foto apa oncam 
//kemudian foto di upload
// ambil data dari url
$id = $_GET['id'];
