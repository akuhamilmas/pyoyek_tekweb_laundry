<?php 
//mengedit data jenis launsry yang sudah ada
// mengambil id jenis yang dipilih
$id = $_GET['id'];
...
if (isset($_POST['ubah'])) {
  ...
  if ($row['jenis_laundry'] !== $jenis_laundry) {
    // mengambil data jenis laundry sesuai dengan inputan jenis laundry
    ...
    // cek apakah jenis laundry sama dengan yang sudah ada
    if ($result_jenis > 0) {
      $pesan_error = "Jenis Laundry <b>$jenis_laundry</b> sudah ada <br>";
    }
  }

  // jika tidak terdapat pesan error, lakukan update jenis
  if ($pesan_error == "") {
...
<div class="container-fluid">
  ...
  <div class="row">
      ...
      <!-- menampilkan notifikasi pesan error  -->
      <?php if ($pesan_error !== "") : ?>
