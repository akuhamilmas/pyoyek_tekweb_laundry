...
// jadi jika tambah di tekan makan kita akan memasukan ke database tapi sebelum itu 
//ada beberapa persyaratan yang harus di lewati sebelum data yang di input masuk ke database
if (isset($_POST['tambah'])) {
  ...
  // jika username ada yg sama maka akan menampilkan sebuah pesan
  if ($result_username > 0) {
    $pesan_error_user = "Username <b>$username</b> sudah digunakan <br>";
  }

  // jika pass tidak sama, maka akan menampilkan pesan error
  if ($userpass !== $userpass2) {
    $pesan_error_pass = "Retype password tidak sesuai <br>";
  }

  // jika tidak ada error, maka data akan di simpan di data base
  if ($pesan_error_user == "" && $pesan_error_pass == "") {
    // enkripsi password, suapaya lebih aman 
...
<div class="container-fluid">
  ...
  <div class="row">
      ...
      <?php endif; ?>
          <!-- ini action dii bawah kosong karena nanti di bawah ada kita memasukan data secara tulisan-->
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select name="level" class="form-control">
                    <!--ini supaya hanya terdapat 2 value klo ngga admin ya user --> 
