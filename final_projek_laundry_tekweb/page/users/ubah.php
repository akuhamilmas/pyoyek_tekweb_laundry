<?php 
// ini ubah hampir sama seperti eksekusi tambah cuman berbeda dari, ambil data
...
if (isset($_POST['ubah'])) {
  ...
  // di bawah ini melakukan pengecekan apa kah nama telah di gunakan, jika telah digunakan
  ...
  // jika password diisi, harus sama jika tidak maka akan muncul notif password tak sesuai
  // jika tak di isi ngga gapapa maka akan lanjut ke selanjutnya
  if ($userpass !== "") {
  ...
  if ($pesan_error_user == "" && $pesan_error_pass == "") {
    // jika password diinput, tidak kosong maka kita akan mengupdate password nya. dan sebaliknya jika kosong maka password tidak akan berubah
    if ($userpass !== "") {
...
<div class="container-fluid">
  ...
  <!-- kemudian untuk form inputan sama seperti yang di index tambah cuman tinggal nambahin ambil data yang di atas 
        setelah itu  setelah mengisi jika kita klik ubak maka melanjutkan proses memasukan data baru ke data base-->
  <div class="row">
      <div class="col-12">
